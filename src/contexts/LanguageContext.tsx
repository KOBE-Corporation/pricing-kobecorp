  ...
  const translations = {
    fr: {
      ...
      contact: {
        ...
        page: {
          title: 'Contact',
          subtitle: 'Échangez avec notre équipe pour vos projets, devis ou questions. Nous sommes disponibles pour vous accompagner.',
    ...
    en: {
      ...
      contact: {
        ...
        page: {
          title: 'Contact',
          subtitle: 'Get in touch with our team for your projects, quotes or questions. We are here to support you.',
          formName: 'Full name',
          formEmail: 'Email',
          formSubject: 'Subject',
          formMessage: 'Message',
